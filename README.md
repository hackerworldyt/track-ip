...
* `git clone git://github.com/hackerworldyt/track-ip.git`
* `cd track-ip`
...
## Single Command :
```
apt update ; apt install git curl -y ; git clone git://github.com/hackerworldyt/track-ip.git ; cd track-ip ; bash trackip
```
<br>
<p align="center">
